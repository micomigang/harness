...
AGENT_SPECS: tuple[AgentSpec, ...] = (
    ...
    AgentSpec(
        ...
        ("已确认剧本", "连续性规则"),
        ("items[].id", "items[].appearance", "items[].wardrobe", "items[].performance", "items[].voice"),
        "Kimi",
    ...
    AgentSpec(
        ...
        ("已确认剧本", "时代与地域约束"),
        ("items[].id", "items[].location", "items[].layout", "items[].lighting", "items[].continuity"),
        "Kimi",
    ...
    AgentSpec(
        ...
        ("已确认剧本", "场次列表"),
        ("items[].id", "items[].description", "items[].state", "items[].used_in"),
        "Kimi",
